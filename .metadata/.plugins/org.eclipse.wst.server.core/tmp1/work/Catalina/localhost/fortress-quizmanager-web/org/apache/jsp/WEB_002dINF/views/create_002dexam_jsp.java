 ...
 * Generated at: 2018-06-24 08:36:51 UTC
...
public final class create_002dexam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Fortress QuizManager | Exam Management</title>\r\n");
      ...
      out.write("\t\t\t\t\t\t</a></li> -->\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<li class=\"nav-item\"><a href=\"exams\" class=\"nav-link\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"nav-icon fa fa-th\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tExams <span class=\"right badge badge-success\">Show All</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t</a></li>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</ul>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<li class=\"breadcrumb-item active\">Create Exam</li>\r\n");
      out.write("\t\t\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"card-title\">Create Exam</h3>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<form role=\"form\" action=\"create-exam\" method=\"POST\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"examTitleName\">Exam Title</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"examTitleName\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter first name\" name=\"examTitleName\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"examDescription\">Exam Description</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<textarea class=\"form-control\" rows=\"3\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter exam description\" id=\"examDescription\" name=\"examDescription\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- /.card-body -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"exams\" class=\"btn btn-default\">Cancel</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
