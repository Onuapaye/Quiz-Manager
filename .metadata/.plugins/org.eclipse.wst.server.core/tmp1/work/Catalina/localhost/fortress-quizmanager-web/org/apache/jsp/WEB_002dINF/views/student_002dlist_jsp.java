 ...
 * Generated at: 2018-06-22 23:41:34 UTC
...
public final class student_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_fortress_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      _jspx_th_fortress_005fforEach_005f0.setVar("userList");
      ...
      try {
        ...
        if (_jspx_eval_fortress_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userList.studentEmail}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userList.studentFirstName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userList.studentLastName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td><span class=\"right badge badge-primary\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form action=\"view-user?viewUser=");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-xs btn-primary\">View</button>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
            out.write("\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span class=\"right badge badge-success\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\taction=\"users?updateUser=");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userList.userName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmethod=\"POST\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-xs btn-success\">Update</button>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
            out.write("\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span class=\"right badge badge-danger\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form action=\"delete-user?deleteUser=");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userList.userName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" method=\"POST\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-xs btn-danger\">Delete</button>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span></td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t");
