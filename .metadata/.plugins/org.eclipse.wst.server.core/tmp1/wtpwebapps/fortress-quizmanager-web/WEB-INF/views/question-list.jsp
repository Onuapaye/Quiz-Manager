		...
		<nav
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" data-widget="pushmenu"
					href="#"><i class="f" C:/Users/Mr Kasapa/eclipse-workspace"afa-bars"></i></a></li>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column"
						...
						<li class="nav-item"><a href="create-question"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									Question <span class="right badge badge-danger">Add New</span>
								</p>
						</a></li>
						...
						<!-- <li class="nav-item"><a href="../widgets.html"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									Users <span class="right badge badge-success">Show All</span>
								</p>
						</a></li> -->
								...
								<div class="card-body table-responsive p-0">
									<table class="table table-hover">
										<tbody>
											...
											<fortress:forEach items="${listOfQuestions}"
												var="questionList">
												<tr>
													...
													<td><span class="right badge badge-primary">
															...
															<form
																action="questions?updateQuestion=${questionList.questionId}"
																method="POST">
															...
															<form
																action="delete-student?deleteQuestion=${questionList.questionId}"
																method="POST">
