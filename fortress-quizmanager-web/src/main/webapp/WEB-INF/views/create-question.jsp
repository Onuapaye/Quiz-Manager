...
<title>Fortress QuizManager | Question Management</title>
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column"
						...
						<li class="nav-item"><a href="questions" class="nav-link">
								<i class="nav-icon fa fa-th"></i>
								<p>
									Questions <span class="right badge badge-success">Show
										All</span>
								</p>
						</a></li>
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="card">
								...
								<!-- form start -->
								<form role="form" action="create-question" method="POST">
									<div class="card-body">

										<div class="form-group">
											<label for="questionTitle">Question Title</label> <input
												type="text" class="form-control" id="firstName"
												placeholder="Enter first name" name="questionTitle">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="form-control" rows="3"
												...
												id="questionInstruction" name="questionInstruction"></textarea>
										</div>
