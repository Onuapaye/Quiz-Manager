...
<title>Fortress QuizManager | Questions Management</title>
					...
					<ul class="nav nav-pills nav-sidebar flex-column"
						...
						<a href="create-question"
							class="nav-link"> <i class="nav-icon fa fa-th"></i>
								<p>
									Questions <span class="right badge badge-danger">Add New</span>
								</p>
						</a>
						</li>

						<li class="nav-item"><a href="questions" class="nav-link">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="users">Questions</a></li>
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="card">
								...
								<form role="form" action="update-question" method="POST">
									<div class="card-body">
										
										<div class="form-group">
											<label for="questionTitle">Question Title</label> <input
												type="text" class="form-control" id="firstName"
												placeholder="Enter first name" name="questionTitle" value="${questionTitle}">
										</div>
										<div class="form-group">
											<label for="questionType"></label> <select class="form-control"
												name="questionType" selected="${selQ-type}">
												<fortress:forEach items="${listOfQuestionTypes}" var="qType">
													<option>${qType}</option>
												</fortress:forEach>
											</select>
										</div>
										<div class="form-group">
											<label for="examId"></label> <select class="form-control"
												name="examId" selected="${selX-type}">
										...
										<div class="form-group">
											<label for="questionInstruction">Question
												Instructions</label>
											<textarea class="form-control" rows="3"
												placeholder="Enter question instruction"
												id="questionInstruction" name="questionInstruction" value="${questionInstruction}"></textarea>
										</div>
									...
									<div class="card-footer">
										<button type="submit" class="btn btn-success">Update
											Question</button>
										<span><a href="questions" class="btn btn-default">Cancel</a></span>
									</div>
								</form>
